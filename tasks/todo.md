...
- Firma simple: nombre, rol, web, teléfono. Sin imágenes. Composición fijada en `send_gmail._FOOTER` (D24 paso 7): "Gonzalo Pérez / Responsable DEMIN Group / demingroupmadrid.com / +34 692 319 217". Teléfono verificado contra `docs/dossier_demin.pdf` + `docs/onboarding_demin.pdf`.
